...
[`public/packages/mcp/policies/`](https://github.com/edgeobs/euno/tree/main/public/packages/mcp/policies). Drop one in your project and run it immediately.
...
See the [policies README](https://github.com/edgeobs/euno/blob/main/public/packages/mcp/policies/README.md) for quick-start instructions and adaptation guidance.
