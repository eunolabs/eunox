...
| Developer education gap — most don't understand _why_ agents need governance | High       | High   | Lead with education content (what can go wrong) before solution marketing (how eunox fixes it); postmortems are the primary vehicle |
