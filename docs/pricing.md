...
### OSS — `@eunox/mcp` (Apache-2.0)

The `@eunox/mcp` package is Apache-2.0 and requires no server-side infrastructure.
...
- **OSS → Cloud Free / Team / Enterprise:** Run `eunox-mcp upgrade-to-hosted`
...
| Component                                             | License                         |
| ----------------------------------------------------- | ------------------------------- |
| `@eunox/mcp` (agent-side proxy, npm)                  | Apache-2.0                      |
