...
secrets management, observability, and identity-provider guides for Euno.
...
| [`k8s/helm/euno/values-azure.yaml`](../k8s/helm/euno/values-azure.yaml) | Helm overrides for AKS |
...
| [`k8s/helm/euno/values-aws.yaml`](../k8s/helm/euno/values-aws.yaml) | Helm overrides for EKS |
...
| [`k8s/helm/euno/values-gcp.yaml`](../k8s/helm/euno/values-gcp.yaml) | Helm overrides for GKE |
...
| Helm umbrella chart | [`k8s/helm/euno/`](../k8s/helm/euno/) with provider-specific values files |
...
gateway:
  env:
    ...
    AZURE_KEYVAULT_URL: "https://my-euno-kv.vault.azure.net/"
