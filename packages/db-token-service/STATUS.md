...
This package provides a database-backed token service for storing and
retrieving issued capability credentials.  It belongs to the Stage-4
operational layer of the [staged execution plan](../../docs/mvp.md#stage-0-stop-the-bleeding-on-the-existing-codebase).
