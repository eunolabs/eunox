// k6 scenario — gateway-proxy-get (auto-generated companion to autocannon).
...
const SCENARIO = 'gateway-proxy-get';
...
export default function () {
  const res = http.get(BASE + '/proxy/api/perf/customers', { headers: HEADERS });
  check(res, {
