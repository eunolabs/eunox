// k6 scenario — issuer-public-key (auto-generated companion to autocannon).
...
const SCENARIO = 'issuer-public-key';
...
export default function () {
  const res = http.get(BASE + '/api/v1/public-key', { headers: HEADERS });
  check(res, {
