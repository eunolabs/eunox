// k6 scenario — issuer-well-known-did (auto-generated companion to autocannon).
...
const SCENARIO = 'issuer-well-known-did';
...
export default function () {
  const res = http.get(BASE + '/.well-known/did.json', { headers: HEADERS });
  check(res, {
