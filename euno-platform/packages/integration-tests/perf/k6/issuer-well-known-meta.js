// k6 scenario — issuer-well-known-meta (auto-generated companion to autocannon).
...
const SCENARIO = 'issuer-well-known-meta';
...
export default function () {
  const res = http.get(BASE + '/.well-known/capability-issuer', { headers: HEADERS });
  check(res, {
