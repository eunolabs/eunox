...
**Middle layer: the gateway reference monitor.** Every outbound operation goes through the gateway. The gateway verifies capability tokens, evaluates conditions, applies obligations, and writes tamper-evident audit records. [Post 10 covers this in detail.](./10-tool-gateway-reference-monitor.md)
