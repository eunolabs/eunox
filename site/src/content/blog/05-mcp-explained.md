...
description: "The Model Context Protocol gives every AI agent a standard way to discover and call tools. Here is what it is, why it matters, and what it means for security."
pubDate: "2024-12-15"
...
But the moment your agents are calling tools with real consequences — sending emails, querying customer data, executing code — you need to think about what sits between the model and the tool. The protocol doesn't do it. That's what a policy proxy is for. [Building a policy proxy for MCP](./06-mcp-policy-proxy) covers what that looks like in practice.
