...
This is the one I'm most proud of because it's the easiest to get wrong. [Post 10 covered the enforcement engine](./10-tool-gateway-reference-monitor.md) in detail, but the key point for this discussion is how the condition registry handles a condition type it doesn't recognize.
