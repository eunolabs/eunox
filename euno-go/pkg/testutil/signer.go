...
import (
	...
	eunocrypto "github.com/edgeobs/euno-platform/euno-go/pkg/crypto"
)

var errInvalidSignature = errors.New("invalid signature")

type inMemorySigner struct {
	algorithm eunocrypto.Algorithm
	keyID     string
...
func MustGenerateRSASigner(keyID string) (eunocrypto.Signer, eunocrypto.Verifier) {
...
func MustGenerateECDSASigner(keyID string) (eunocrypto.Signer, eunocrypto.Verifier) {
...
func MustGenerateEdDSASigner(keyID string) (eunocrypto.Signer, eunocrypto.Verifier) {
